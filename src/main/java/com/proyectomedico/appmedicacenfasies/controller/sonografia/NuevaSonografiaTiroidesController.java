...
import com.proyectomedico.appmedicacenfasies.dto.sonografias.SonografiaTiroidesDTO;
...
public class NuevaSonografiaTiroidesController {
    ...
    @FXML private TextArea txtGlandulaTiroides;
    @FXML private TextArea txtLobuloDerecho;
    @FXML private TextArea txtLobuloIzquierdo;
    @FXML private TextField txtIstmo;
    @FXML private TextField txtTraquea;
    @FXML private TextField txtPlanoMuscular;
    @FXML private TextField txtTiRads;
    ...
    public void guardarSonografia(ActionEvent event) {
        try {
            if (pacienteIdActual == null) {
                ...
                var nuevoPaciente = pacienteService.obtenerOCrearPacienteBasico(cedulaSegura, nombre, null, null, fechaNacimientoAprox, "No Especificado");
            ...
            // Empaquetar DTO
            SonografiaTiroidesDTO dto = new SonografiaTiroidesDTO(
                    medicoRealizador,
                    txtDiagnostico.getText(),
                    txtGlandulaTiroides.getText(),
                    txtLobuloDerecho.getText(),
                    txtLobuloIzquierdo.getText(),
                    txtIstmo.getText(),
                    txtTraquea.getText(),
                    txtPlanoMuscular.getText(),
                    txtTiRads.getText()
            );
            // Guardar
            sonografiaService.guardarSonografiaTiroides(pacienteIdActual, dto);
            ...
            if (sesionGlobal.haySesionActiva() && sesionGlobal.getUsuarioLogueado() instanceof Medico doctor) {
                ...
                if (necesitaTurno) {
                    ...
                    if (pacienteEntity != null) {
                        ...
                        autoTurno.setTipoEstudio("TIROIDES");
            ...
            log.error("Error al guardar la sonografía de tiroides", e);
